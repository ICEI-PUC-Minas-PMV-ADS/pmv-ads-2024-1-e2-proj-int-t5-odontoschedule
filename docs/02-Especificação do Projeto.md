...
| RF-05 | A aplicação deve permitir que o paciente seja capaz de agendar uma consulta passando as seguintes informações: especialidade desejada, horário, dentista e modalidade (particular ou convênio)  | Alta  |
